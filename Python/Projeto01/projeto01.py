...
#para cada cpf/carteira é necessário descobrir os 3 mais proximos e classificar o perfil
...
def calculaMaisProximos(k ,item_no_class, data):
    lista = []
    x=0
...
for item_no_class in no_class:
        item_no_class[1] = calculaMaisProximos( 3, item_no_class[2], data)      
print(no_class)